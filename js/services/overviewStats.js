...
const SPECIAL_LISTENING_CATEGORIES = [
    { id: 'listening-p1-100', category: '100 P1', type: 'listening', path: 'assets/listening/100 P1', filterMode: 'frequency-p1' },
    { id: 'listening-p4-100', category: '100 P4', type: 'listening', path: 'assets/listening/100 P4', filterMode: 'frequency-p4' }
];
...
window.AppServices.overviewStats = overviewStats;
