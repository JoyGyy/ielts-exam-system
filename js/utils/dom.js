...
if (!window.DOMAdapter && typeof document !== 'undefined') {
    ...
    window.DOMAdapter = {
        create: function(tag, attributes, children) {
            if (window.DOM && typeof window.DOM.create === 'function') {
                return window.DOM.create(tag, attributes, children);
            }
            return fallbackCreate(tag, attributes, children);
        },
        replaceContent: function(container, content) {
            if (window.DOM && typeof window.DOM.replaceContent === 'function') {
                window.DOM.replaceContent(container, content);
                return;
            }
            fallbackReplaceContent(container, content);
        },
        fragment: function(items, factory) {
            if (window.DOM && window.DOM.builder && typeof window.DOM.builder.createFragment === 'function') {
                return window.DOM.builder.createFragment(items, factory);
            }
